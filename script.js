    ...
    class Effect{
        constructor(context, canvasWidth, canvasHeight){
            ...
            this.fontFamilySelect.addEventListener('change', (e) => {
                ...
                this.wrapText(this.textInput.value, this.fontFamily[e.target.value]);
            });
       ...
       wrapText(text, font){
        ...
        this.context.font = `${this.fontSize}px ${fontFamilySelect.value}`
